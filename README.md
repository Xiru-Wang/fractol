...
# Mandelbrot VS Julia
Those fascinating fractals are generated by a simple mathematical formula with complex numbers.
...
See? That's how we get our x-axis(real), and y-axis(imaginary).
